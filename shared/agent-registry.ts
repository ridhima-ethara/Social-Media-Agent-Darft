...
const CALENDAR_SKILLS: SkillSpec[] = [
  ...
  },
  {
    ...
    config: [
      ...
      num('autoWriteWeeks', 'Weeks written automatically', 1,
        'How many calendar weeks a run writes and illustrates on its own. One writes THIS week\u2019s posts, caption and creative, and leaves next week\u2019s placed but unwritten \u2014 they wait on the calendar as \u201cNo caption yet\u201d and are written when their week arrives or when someone drafts them from the card. Two writes the whole plan up front. Whatever this is set to, a post that has been written keeps its slot and its date: ranking only rearranges posts with no caption yet, so a later run cannot demote written content for a higher-scoring newcomer.',
        { min: 1, max: 2, step: 1, unit: 'weeks' }),
