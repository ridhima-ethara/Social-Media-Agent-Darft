...
export function ThemeToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`rounded-md border border-line-strong p-1.5 text-ink-3 transition-colors duration-[var(--dur-fast)] hover:border-line-strong hover:text-ink ${className}`}
    >
